...
%\input{sections/discussion/shortcomings/reinforcement.sub.sub.sec.tex}
...
%a better solution for the future might be to use an architecture that allows
