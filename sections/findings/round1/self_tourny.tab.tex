...
\caption{
	...
	%
	\textbf{Score} indicates the number of points scored according to ACC
	rules for match play;
	\textbf{Spread} is the cumulative point spread for the first player,
	omitted for the opponent for readability;
	and \textbf{Wins} is the total number of games each player won in the match.
}
