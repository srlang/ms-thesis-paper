...
%
Here it is seen that the agent is learning these checkpoints through its
play.
%%%
...
with similar results shown in Fig~\ref{fig_r1-spreads_b}.
%%%
...
off against one another in a ``winner's bracket,''
there was also a ``loser's bracket'' created
