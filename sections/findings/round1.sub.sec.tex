...
%
%Because of the stipulation on the variance previously explained in 
%Section~\ref{sec:dm},
% TODO: check which way we want to go with this
%	option 1: remove from methods and explain briefly here
During Round 1,
