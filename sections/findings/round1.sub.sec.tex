...
without exploration.
%
As can be seen in Table~\ref{tab:r1-randtourny},
...
%these states will likely remain in this cycle.
...
%%%
% TODO: play an agent against a previous version of itself
%%%
...
%
As seen in Table~\ref{tab:r1-selftourny},
...
%
Figure~\ref{fig:r1-spreads} show ...
%%%
