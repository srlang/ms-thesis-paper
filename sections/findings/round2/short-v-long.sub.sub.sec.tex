...
%
% TODO(chelsea): what?
Play is approximately evenly matched when between agents
when the opposing agent has been trained for 300,000 to 700,000 games.
%
Following these matches,
the agent begins to, again, win more consistently when more training is done.
% TODO: ^^^ rewrite performance analysis since we know results
%%%
