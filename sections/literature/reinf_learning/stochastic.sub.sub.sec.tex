...
%
This leads the authors to the conclusion that the success of TD-Gammon was
more likely
...
and not necessarily a result of the technique used in optimizing the neural network.
%
